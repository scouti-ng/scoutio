        ...
        if (params.pwd === 'KaterCiller') {
            return `<html>
                ...
                <body id="bigpage">
                    ...
                    <button id="follow-btn">Follow Data</button><input type="file" id="graph-file" name="graph-file" accept="application/json"><button id="load-btn">Load</button><button id="playpause-btn" style="width: 100px">Play</button><input type="number" id="speed" min="0" max="10" value="1"><br/>
