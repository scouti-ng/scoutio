        ...
        if (params.pwd === 'KaterCiller') {
            return `<html>
                ...
                <body id="bigpage">
                    ...
                    <button id="follow-btn">Follow Data</button><input type="file" id="graph-file" name="graph-file" accept="application/json"><button id="load-btn">Load</button><button id="playpause-btn" style="width: 100px">Play</button><br/>
